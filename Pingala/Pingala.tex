...
\begin{lstlisting}
$ wget https://github.com/amaan28/EE3900/blob/main/Pingala/codes/Ex_1.py
\end{lstlisting}
\end{enumerate}
...
\begin{lstlisting}
$ wget https://github.com/amaan28/EE3900/blob/main/Pingala/codes/Ex_2.2.py
\end{lstlisting}
\begin{figure}[!ht]
	\centering
...
\begin{lstlisting}
$ wget https://github.com/amaan28/EE3900/blob/main/Pingala/codes/Ex_2.5.py
\end{lstlisting}
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\columnwidth]{./figs/Ex_2.5.png}
