...
%
\author{ Amaan %<-this  stops a space
% <-this % stops a space
...
\\
\newline\solution The following C code yields Fig. \ref{fig:3.3}.
\begin{lstlisting}
https://github.com/amaan28/EE3900/blob/main/codes/Ex_3.3.c
\end{lstlisting}
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\columnwidth]{./figs/Ex_3.3.png}
\end{center}
\captionof{figure}{}
\label{fig:3.3}	
\end{figure}
...
\end{lstlisting}
	...
	\solution
	%\begin{align}
	%	\vec{x} &= \brak{{1 & 2 & 3 & 4 & 2 & 1}}^\top 
	%\end{align}
%\begin{align}
%	\vec{h} &= \brak{{h_0 & h_1	 & \cdots & h_{N-1}}}^\top \\
%\end{align}
...
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/prajwal-3-14159/EE3900_ma20btech11013/main/filter/codes/problem_8-2-1.py
\end{lstlisting}
	The filter frequency response is plotted at
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/prajwal-3-14159/EE3900_ma20btech11013/main/filter/codes/problem_8-2-2.py
\end{lstlisting}
...
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/prajwal-3-14159/EE3900_ma20btech11013/main/filter/codes/problem_8-2-3.py
\end{lstlisting}
	\begin{figure}[!htb]
%		\includegraphics[width=\columnwidth]{figs/prob_7-2-1.png}
		\caption{Plot of $h(n)$}
		\label{fig:butter-imp}
	\end{figure}
	\begin{figure}[!htb]
%		\includegraphics[width=\columnwidth]{figs/prob_7-2-2.png}
		\caption{Filter frequency response}
		\label{fig:butter-resp}
	\end{figure}
	\begin{figure}[!htb]
%		\includegraphics[width=\columnwidth]{figs/prob_7-2-3.png}
		\caption{Plot of $y(n)$}
